...
namespace UnityEngine
{
    ...
    {
        private UAudioComponent componentU1_ = null;

        public UAudioComponent componentU1
        {
            get
            {
                if (componentU1_ == null)
                {
                    componentU1_ = GameObject.GetU1ChildComponent<UAudioComponent>(u1Component);
                }
        ...
        {
            componentU1 =
                owner.AddComponentByClass(UAudioComponent.StaticClass(), false, FTransform.Identity, false) as
                    UAudioComponent;
            UObject metaSoundTemplate = Unreal.LoadObject<UObject>(null, "/Game/Library/MetaSoundTemplate");
            if (metaSoundTemplate != null && componentU1 != null)
            {
                componentU1.SetSound(metaSoundTemplate as USoundBase);
                componentU1.bCanPlayMultipleInstances = true;
            }
        }
        ...
        static private void PlayHelper([NotNull] AudioSource source, UInt64 delay)
        {
            source.Play((double)delay);
        }

        private void Play(double delay)
        {
            componentU1.SetPaused(false);
            componentU1.Play(0f);
        }

        static private void PlayOneShotHelper([NotNull] AudioSource source,
            [NotNull("NullExceptionObject")] AudioClip clip, float volumeScale)
        {
            source.loop = false;
            var cpnt = source.componentU1;
            cpnt.SetSound(clip.sound);
            cpnt.SetVolumeMultiplier(volumeScale);
            cpnt.Play();
        }
        ...
        [NativeThrows]
        extern static private void SetCustomCurveHelper([NotNull] AudioSource source, AudioSourceCurveType type,
            AnimationCurve curve);

        extern static private AnimationCurve GetCustomCurveHelper([NotNull] AudioSource source,
            AudioSourceCurveType type);

        extern static private void
            GetOutputDataHelper([NotNull] AudioSource source, [Out] float[] samples, int channel);

        [NativeThrows]
        extern static private void GetSpectrumDataHelper([NotNull] AudioSource source, [Out] float[] samples,
            int channel, FFTWindow window);

        // The volume of the audio source (0.0 to 1.0)
        public float volume
        {
            get { return componentU1.VolumeMultiplier; }
            set { componentU1.SetVolumeMultiplier(value); }
        }
        ...
        [NativeProperty("SecPosition")] extern public float time { get; set; }
        ...
        public AudioClip clip
        {
            get
            {
                var parasInstance = componentU1.InstanceParameters;
                var parasDefault = componentU1.DefaultParameters;
                foreach (var p in parasInstance)
                {
                    if (p.ParamName == "soundwave" && p.ObjectParam is USoundWave)
                        return new AudioClip((USoundWave)p.ObjectParam);
                }

                foreach (var p in parasDefault)
                {
                    if (p.ParamName == "soundwave" && p.ObjectParam is USoundWave)
                        return new AudioClip(p.ObjectParam as USoundWave);
                }
            ...
            set
            {
                if (value == null)
                    return;
                USoundWave soundwave = value.sound;
                componentU1.SetWaveParameter("soundwave", soundwave);
            }
        }
        ...
        [NativeConditional("PLATFORM_SUPPORTS_GAMEPAD_AUDIO")]
        [NativeMethod(Name = "AudioSourceBindings::SetDualShock4SpeakerMixLevel", HasExplicitThis = true,
        ...
        [NativeConditional("PLATFORM_SUPPORTS_GAMEPAD_AUDIO")]
        [NativeMethod(Name = "AudioSourceBindings::SetDualShock4SpeakerMixLevelDefault", HasExplicitThis = true,
            ThrowsException = true)]
        ...
        [NativeConditional("PLATFORM_SUPPORTS_GAMEPAD_AUDIO")]
        [NativeMethod(Name = "AudioSourceBindings::SetDualShock4SpeakerRestrictedAudio", HasExplicitThis = true,
            ThrowsException = true)]
        ...
        [NativeConditional("PLATFORM_SUPPORTS_GAMEPAD_AUDIO")]
        [NativeMethod(Name = "AudioSourceBindings::SetGamepadSpeakerMixLevel", HasExplicitThis = true,
            ThrowsException = true)]
        [Obsolete("Use SetGamepadSpeakerMixLevel instead")]
        extern public bool SetDualShock4PadSpeakerMixLevelPadIndex(Int32 slot, Int32 mixLevel);

        [NativeConditional("PLATFORM_SUPPORTS_GAMEPAD_AUDIO")]
        [NativeMethod(Name = "AudioSourceBindings::SetGamepadSpeakerMixLevelDefault", HasExplicitThis = true,
            ThrowsException = true)]
        [Obsolete("Use SetGamepadSpeakerMixLevelDefault instead")]
        extern public bool SetDualShock4PadSpeakerMixLevelDefaultPadIndex(Int32 slot);

        [NativeConditional("PLATFORM_SUPPORTS_GAMEPAD_AUDIO")]
        [NativeMethod(Name = "AudioSourceBindings::SetGamepadSpeakerRestrictedAudio", HasExplicitThis = true,
            ThrowsException = true)]
        [Obsolete("Use SetGamepadSpeakerRestrictedAudio instead")]
        ...
        public bool isPlaying
        {
            ...
            get
            {
                var state = componentU1.GetPlayState();
                return state == EAudioComponentPlayState.Playing;
            }
        }
        ...
        private USoundNodeWavePlayer FindSoundNodeWavePlayer()
        {
            var cue = (USoundCue)componentU1.Sound;
            var nodes = cue.AllNodes;
            foreach (USoundNode n in nodes)
            {
                if (n is USoundNodeWavePlayer)
                    return (USoundNodeWavePlayer)n;
            }

            return null;
        }

        private bool GetBoolParameter(string name)
        {
            var paras = componentU1.InstanceParameters;
        ...
        public bool loop
        {
            get { return GetBoolParameter("loop"); }
            set { componentU1.SetBoolParameter("loop", value); }
        }
        ...
        [NativeProperty("StereoPan")] extern public float panStereo { get; set; }

        // Sets how much a playing sound is treated as a 3D source
        [NativeProperty("SpatialBlendMix")] extern public float spatialBlend { get; set; }
        ...
        public bool mute
        {
            get { return GetBoolParameter("mute"); }
            set { componentU1.SetBoolParameter("mute", value); }
        }
...
namespace UnityEngine
{
    ...
    public sealed partial class AudioSettings
    {
        ...
        extern static public AudioSpeakerMode driverCapabilities { [NativeName("GetSpeakerModeCaps")] get; }
...
#pragma warning restore 0067
    ...
    public sealed class AudioClip : Object
    {
        ...
        {
            path = "/Game/" + path;
            USoundWave x = Unreal.LoadObject<USoundWave>(null, path);
            AudioClip clip = new AudioClip(x);
            return clip as Object;
        }
        ...
        extern static private bool GetData([NotNull("NullExceptionObject")] AudioClip clip, [Out] float[] data,
            int numSamples, int samplesOffset);

        extern static private bool SetData([NotNull("NullExceptionObject")] AudioClip clip, float[] data,
            int numsamples, int samplesOffset);
        ...
        extern public bool isReadyToPlay { [NativeName("ReadyToPlay")] get; }
    ...
    public sealed class AudioListener : AudioBehaviour
    {
        ...
        [NativeProperty("ListenerPause")] extern static public bool pause { get; set; }
    ...
    public sealed partial class AudioLowPassFilter : Behaviour
    {
        ...
        extern static private void SetCustomLowpassLevelCurveHelper(
            [NotNull("NullExceptionObject")] AudioLowPassFilter source, AnimationCurve curve);
    ...
    public sealed class Microphone
    {
        ...
        static public AudioClip Start(string deviceName, bool loop, int lengthSec, int frequency)
        {
            ...
            if (lengthSec <= 0)
                throw new ArgumentException("Length of recording must be greater than zero seconds (was: " + lengthSec +
                                            " seconds)");

            if (lengthSec > 60 * 60)
                throw new ArgumentException("Length of recording must be less than one hour (was: " + lengthSec +
                                            " seconds)");

            if (frequency <= 0)
                throw new ArgumentException("Frequency of recording must be greater than zero (was: " + frequency +
                                            " Hz)");
        ...
        extern static public string[] devices { [NativeName("GetRecordDevices")] get; }
