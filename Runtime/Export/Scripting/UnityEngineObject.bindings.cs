...
#pragma warning restore 649
        ...
        public static AsyncInstantiateOperation<T> InstantiateAsync<T>(T original, InstantiateParameters parameters) where T : UnityEngine.Object
        {
            return InstantiateAsync(original, 1, parameters);
        }

        public static AsyncInstantiateOperation<T> InstantiateAsync<T>(T original, int count, InstantiateParameters parameters) where T : UnityEngine.Object
        {
            return InstantiateAsync(original, count, ReadOnlySpan<Vector3>.Empty,  ReadOnlySpan<Quaternion>.Empty, parameters);
        }

        public static AsyncInstantiateOperation<T> InstantiateAsync<T>(T original, Vector3 position, Quaternion rotation, InstantiateParameters parameters) where T : UnityEngine.Object
        {
            return InstantiateAsync(original, 1, position, rotation, parameters);
        }

        public static AsyncInstantiateOperation<T> InstantiateAsync<T>(T original, int count, Vector3 position, Quaternion rotation, InstantiateParameters parameters) where T : UnityEngine.Object
        {
            unsafe
            {
                return InstantiateAsync(original, count, new ReadOnlySpan<Vector3>(&position, 1),  new ReadOnlySpan<Quaternion>(&rotation, 1), parameters);
            }
        }
        ...
        [MethodImpl(256 | 512)]
        public static AsyncInstantiateOperation<T> InstantiateAsync<T>(T original, int count, ReadOnlySpan<Vector3> positions, ReadOnlySpan<Quaternion> rotations, InstantiateParameters parameters) where T : UnityEngine.Object
        {
            ...
            unsafe
            {
                ...
                {
                    AsyncInstantiateOperation op = Internal_InstantiateAsyncWithParams(original, count, parameters, (IntPtr)positionsPtr, positions.Length, (IntPtr)rotationsPtr, rotations.Length);
